...
SURVEY_WAS_BEFORE = [
    ...
    "мурда болгону(ң|н)узбу", "мурда болгону(ң|н)узба",
    "болгонсузбу", "болгонсузба", "болгонсуздарбы",
    "мурда келгени(ң|н)из барбы", "мурда болгонсузбу",
]
...
SURVEY_PAWN_OR_BUY = [
    ...
    "залок","выкупту","выкупка","кепилдик"
]
